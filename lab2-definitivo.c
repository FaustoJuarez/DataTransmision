...
uint8_t EnviarComandoAT(LPC_USART_T *pUART_MODEM, char AT[])
{
    ...
    {
        UARTEscribirByte(pUART_MODEM, AT[i]);
    }
...
void ConfigurarMODEM(LPC_USART_T *pUART_USB, LPC_USART_T *pUART_MODEM)
{
    uint8_t aux;
    uint8_t err;
    //Reseteo la placa poniendo KEY=1
    ...
    if (1)
    {
        ...
        EnviarComandoAT(pUART_MODEM, "AT+NAME=fmBT\r\n");
        EnviarComandoAT(pUART_MODEM, "AT+PSWD=fm123\r\n");
...
//Alumnos Juarez Yelamos Fausto, Ruiz Francisco Mauricio